...
rm -rf APP/data/variants.varscan/*_snps_variants.vcf && rm -rf APP/data/variants.varscan/*_file.mpileup
...
do
    ...
    varscan pileup2snp APP/data/variants.varscan/"$id"_file.mpileup --min-coverage $Dp --min-avg-qual $Qual > APP/data/variants.varscan/"$id"_snps_variants.vcf

done

mv APP/data/variants.varscan/*snps_variants.vcf  APP/data/variants.varscan/Filterring
